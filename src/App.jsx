      ...
      {vista === "metodologia" && (
        <div style={{ flex: 1, width: "100%", padding: "52px 48px", animation: "fadeUp 0.25s ease" }}>
          <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
            ...
            <p style={{ fontSize: 17, color: T.textMid, marginBottom: 36, lineHeight: 1.7 }}>Munilupa reúne la experiencia real de las empresas desarrolladoras y constructoras del AMBA. Los índices reflejan esa experiencia agregada, no la posición de ninguna organización ni partido político.</p>
          </div>
          <div style={{ maxWidth: 860, margin: "0 auto", display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              { icon: "⚖️", titulo: "¿Cómo se calcula el índice?", texto: `Transparencia (25%) · Velocidad de aprobación (25%) · Claridad normativa (10%) · Previsibilidad (15%) · Atención al público (10%) · Razonabilidad de tasas (15%). El índice de cada municipio se calcula en dos pasos: primero se promedian todas las reseñas de cada empresa —incluidos sus distintos tipos de obra— para obtener un único valor por empresa, y luego se promedian esos valores entre empresas (una empresa = un voto). Así, calificar más tipos de obra no otorga más peso. En el mapa podés ver el Índice Municipal general o aislar cualquiera de las seis categorías.` },
              ...
              <div key={i} className="metodologia-card" style={{ background: T.bg, border: `1px solid ${T.border}`, borderRadius: T.radius, padding: "28px 36px", display: "flex", alignItems: "flex-start", gap: 22, boxShadow: T.shadowCard }}>
